...
public class GasMeterVo {
	...
	public String toString() {
		return "GasMeterVo [home_code=" + home_code + ", mdate=" + mdate + ", device_id=" + device_id + ", device_type="
				+ device_type + ", measure_value=" + measure_value + ", use_value=" + use_value + ", device_status="
				+ device_status + ", rdate=" + rdate + "]";
	}	
}
